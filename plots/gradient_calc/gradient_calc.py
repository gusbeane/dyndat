...
print("Jrfac: ", meanJrhigh/meanJrlow, "Lzfac: ", meanLzhigh/meanLzlow, "Jzfac: ", meanJzhigh/meanJzlow)
...
Jruncert = np.nanstd(Jrgrad, ddof=1)
Lzuncert = np.nanstd(Lzgrad, ddof=1)
Jzuncert = np.nanstd(Jzgrad, ddof=1)

print("Jr uncert: ", Jruncert, "Lz uncert: ", Lzuncert, "Jz uncert: ", Jzuncert)
